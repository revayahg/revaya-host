-- SECURE RLS POLICIES - Based on ACTUAL database schema
...
-- ACTUAL SCHEMA: id, event_id, subject, last_message_at, last_message_preview, created_at, is_archived
-- NO created_by column - access control via event_user_roles only
...
-- No update/delete policies for message_threads since there's no created_by column
-- Threads are managed by the system, not individual users

-- Step 5: Create secure policies for messages table
-- ACTUAL SCHEMA: id, thread_id, sender_id, body, created_at
...
-- ACTUAL SCHEMA: id, event_id, title, description, category, type, status, priority, due_date, assigned_to, created_at, updated_at
-- NO created_by column - access control via event_user_roles only
...
-- ACTUAL SCHEMA: id, user_id, type, title, message, read, created_at, event_id, etc.
...
-- ACTUAL SCHEMA: id, event_id, x, y, assignee_vendor_id, vendor_name, visible_to_vendor, created_at, updated_at
-- NO created_by column - access control via event_user_roles only
...
-- ACTUAL SCHEMA: id, email, first_name, last_name, created_at, updated_at, etc.
