-- EMERGENCY FIX: Completely disable RLS on problematic tables
-- This will allow the collaborator system to work while we fix the policies

-- Disable RLS completely on event_user_roles
ALTER TABLE event_user_roles DISABLE ROW LEVEL SECURITY;

-- Disable RLS completely on event_collaborator_invitations  
