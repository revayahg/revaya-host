      ...
      <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="background-color: #f0f4ff; border-left: 4px solid #667eea; margin: 20px 0;">
        <tr>
          <td style="padding: 20px;">
            ...
            <p style="color: #1f2937; margin: 10px 0; font-size: 15px; font-family: Arial, sans-serif;"><strong style="color: #1e40af;">DEBUG - Start Date Raw:</strong> ${data.start_date || 'NULL'}</p>
            <p style="color: #1f2937; margin: 10px 0; font-size: 15px; font-family: Arial, sans-serif;"><strong style="color: #1e40af;">DEBUG - Edge Function Version:</strong> VERSION 5 - FORCE REDEPLOY - Updated 2025-01-23 21:45</p>
          </td>
        </tr>
      </table>
    `;
...
// VERSION 6 - NEW FUNCTION - Updated with start_date support for task notifications
serve(async (req) => {
  ...
  try {
    ...
    // Debug: Log start_date specifically
    console.log('🔍 Email template debug - start_date:', requestBody.start_date);
    console.log('🔍 Email template debug - due_date:', requestBody.due_date);
    console.log('🔍 Email template debug - full data:', JSON.stringify(requestBody, null, 2));
    console.log('🔍 Email template debug - VERSION 5 - MAJOR UPDATE - Edge function updated with start_date support');
    console.log('🔍 Email template debug - start_date value:', requestBody.start_date);
    console.log('🔍 Email template debug - due_date value:', requestBody.due_date);
