...
DROP POLICY IF EXISTS "System can insert invitation reminders" ON invitation_reminder_emails;
DROP POLICY IF EXISTS "Users can view their own invitation reminders" ON invitation_reminder_emails;
