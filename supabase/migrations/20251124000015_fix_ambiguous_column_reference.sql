-- Fix ambiguous column reference "event_id"
-- PostgreSQL can't determine if event_id refers to table column or variable
-- Solution: Use explicit table aliases and qualify all column references
-- Date: 2025-11-24

SET statement_timeout TO 0;
SET lock_timeout TO 0;

-- Drop and recreate with explicit table aliases
