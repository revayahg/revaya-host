    ...
    return (
      <Layout>
        <div data-name="homepage" className="min-h-screen bg-white">
          {/* Hero Section */}
          <section data-name="hero-section" className="homepage-hero relative bg-gradient-to-r from-blue-50 to-indigo-50 py-20">
          ...
          <section className="homepage-section py-20 bg-gray-50">
            <div className="container mx-auto px-4">
              <h2 className="text-3xl font-bold text-center mb-12">How It Works</h2>
              
              <div className="flex justify-center">
                <div data-name="role-toggle" className="role-toggle bg-gray-100 rounded-full p-1">
                  <button
          ...
          {/* Features Section */}
          <section className="homepage-section homepage-features py-20">
            <div className="container mx-auto px-4">
          ...
          {/* CTA Section */}
          <section className="homepage-cta bg-indigo-900 text-white py-20">
          ...
          {/* Footer */}
          <footer className="homepage-footer bg-gray-100 py-8">
            <div className="container mx-auto px-4">
