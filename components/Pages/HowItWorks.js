function HowItWorks() {
  try {
    ...
    return (
      <section data-name="how-it-works" className="how-it-works-section py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-6">How It Works</h2>
            <div className="how-it-works-tabs inline-flex bg-gray-100 rounded-full p-1">
              <button
          ...
          <div className="how-it-works-steps grid md:grid-cols-3 gap-8">
            {(activeView === 'organizer' ? organizerSteps : vendorSteps).map((step, index) => (
              <div
                key={index}
                data-name={`step-${index + 1}`}
                className="how-it-works-step p-6 bg-white rounded-lg border border-gray-200 hover:shadow-lg transition-all duration-200"
              >
                <div className="how-it-works-step-icon w-16 h-16 bg-indigo-100 rounded-full flex items-center justify-center text-indigo-600 mb-6 mx-auto">
